...
let foodArray = ['pizza','cheeseburger','pho','drunken noodles','calamari']
...
console.log('The number of favorite foods I have is:',foodArray.length);
...
console.log('The 4th animal is:',animalArray[3]);

// 3.c. (STRETCH) TODO: Log the last animal by using the array length, 
//      instead of the exact index number of the last item
console.log('The LAST animal is:', animalArray[ ( animalArray.length - 1 ) ] );
//Should this not be animalArray.length()-1 ? seems to work. Odd. 
